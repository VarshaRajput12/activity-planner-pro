...
export type Database = {
  ...
  public: {
    Tables: {
      activities: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "activities_poll_id_fkey"
            columns: ["poll_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "activities_poll_option_id_fkey"
      ...
      activity_participation: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "activity_participation_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      leaderboard_entries: {
        ...
        Relationships: [
          {
            foreignKeyName: "leaderboard_entries_activity_id_fkey"
            columns: ["activity_id"]
            isOneToOne: false
            referencedRelation: "activities"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "leaderboard_entries_marked_by_fkey"
            columns: ["marked_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Enums: {
      ...
      app_role: "admin" | "user"
      participation_status: "pending" | "accepted" | "rejected"
